...
def main(args: argparse.Namespace):
    ...
    with open(index_path) as f:
        new_experiment.load_dict(yaml.load(f, Loader=yaml.SafeLoader)['articulated_kit'])
    ...
    for tag in tags:
        ...
        new_experiment.targets.append(new_target.get_dict())

    with open(index_path, "w") as f:
        yaml.dump({'articulated_kit': new_experiment.get_dict()}, f, sort_keys=False)

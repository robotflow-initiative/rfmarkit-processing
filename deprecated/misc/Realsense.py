...
class RealsenseCameraSystem:
    def __init__(self, path_to_recording, mask: List[str]=None):
        ...
        self.cameras: List[RealsenseCamera] = []
    ...
    def parse(self):
        ...
        for camera_path in camera_path_list:
            self.cameras.append(RealsenseCamera(path_to_camera=camera_path))
...
if __name__ == '__main__':
    r = RealsenseCameraSystem("/Users/liyutong/Downloads/bulu-0-0")
    print(r)
